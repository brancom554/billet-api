...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\HtmlMacroServiceProvider::rawLabel()
         * @param mixed $name
         * @param mixed $value
         * @param mixed $options
         * @static 
        ...
        {
                        return \Collective\Html\FormBuilder::rawLabel($name, $value, $options);
        }
                    /**
         * 
         *
         * @see \App\Providers\HtmlMacroServiceProvider::labelWithHelp()
         * @param mixed $name
         * @param mixed $value
         * @param mixed $options
         ...
         * @static 
         */ 
        public static function labelWithHelp($name, $value, $options, $help_text)
        {
                        return \Collective\Html\FormBuilder::labelWithHelp($name, $value, $options, $help_text);
        }
                    /**
         * 
         *
         * @see \App\Providers\HtmlMacroServiceProvider::customCheckBox()
         * @param mixed $name
         * @param mixed $value
         * @param mixed $checked
         * @param mixed $label
         ...
         * @static 
         */ 
        public static function customCheckbox($name, $value, $checked = false, $label = false, $options = [])
        {
                        return \Collective\Html\FormBuilder::customCheckbox($name, $value, $checked, $label, $options);
        }
                    /**
         * 
         *
         * @see \App\Providers\HtmlMacroServiceProvider::styledFile()
         * @param mixed $name
         * @param mixed $multiple
         * @static 
         */ 
        public static function styledFile($name, $multiple = false)
        {
                        return \Collective\Html\FormBuilder::styledFile($name, $multiple);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\HtmlMacroServiceProvider::sortableLink()
         * @param mixed $title
         * @param mixed $active_sort
         * @param mixed $sort_by
         ...
         * @static 
         */ 
        public static function sortable_link($title, $active_sort, $sort_by, $sort_order, $url_params = [], $class = '', $extra = '')
        {
                        return \Collective\Html\HtmlBuilder::sortable_link($title, $active_sort, $sort_by, $sort_order, $url_params, $class, $extra);
        }
